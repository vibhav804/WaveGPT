    ...
    <div className="Chat">
      ...
      <Row id="chatbar">
        ...
        <Row>
          ...
          <Form.Text>I designed and built this website from scratch. Vibhav Singh © 2023. Free Research Preview. Our goal is to make AI systems more natural and safe to interact with. Your feedback will help us improve.</Form.Text>
        </Row>
      </Row>
    </div>
  );
